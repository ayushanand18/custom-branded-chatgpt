...
function ChatContainer({
    ...
    const loadingAnim = (e) => {
        return (<span className="blinkBox">
            <span></span>
        </span>)
    }
    ...
    const renderedDiv = defaultDoc?.userPrompts?.map((data, index) => {
        return (
            <div className="wrapChatList">
                <div key={index+"user"} className="user">
                    <div className="innerWrapper">
                        <div className="avatarIcon">
                        {/* // <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" role="img">
                            //     <title>User</title>
                            //     <text x="-9999" y="-9999">User</text>
                        ...
                        <div className="chatContent">{data}</div>
                    </div>
                </div>
                <div key={index+"chatgpt"} className="chatgpt">
                    <div className="innerWrapper">
                        <div className="avatarIcon gptIcon">
                            <img src={Logo} className="appLogo" alt="logo" width="30px" />
                            {/*<svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" strokeWidth="1.5" role="img">
                                <title>ChatGPT</title>
                        ...
                        <div className="chatContent" >{(loadingAnim && (defaultDoc.gptResponse[index]==="thinking ...")) || defaultDoc.gptResponse[index]}</div>
                    </div>
                </div>
            </div>
        )
    ...
    return (
        <div className="containerWrapper">
            ...
            <div className="divOne">
                <form className="formOne" onSubmit={handleSubmitPrompt}>
